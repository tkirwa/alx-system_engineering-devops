...
def count_words(subreddit, word_list, after='', word_dict={}):
    """ A function that queries the Reddit API, parses the titles of all hot articles,
    ...
    if after is None:
        ...
        # Print the sorted count for each keyword with occurrences greater than 0
        for word in wordict:
            if word[1]:
    ...
    try:
        # Parse the JSON response to get the list of hot articles and the 'after' parameter
